    ...
    <Box bg="gray.100">
      <Container maxW={{ base: "container.sm", xl: "container.xl" }} py="5rem">
        <Stack
          ...
          spacing="2.75rem"
        >
          <Stack direction={{ base: "column", sm: "row" }} spacing="2.75rem">
            {/* Logo & Links */}
            <Stack direction="column">
              <Box>
                <Heading as="h3" size="h3" color="black">
                  Bring Images to Live
                </Heading>
              </Box>
              <Text>Enhance your static AI</Text>
            ...
            <Stack direction="column" spacing="1.5rem">
              ...
              <Stack direction="row" spacing="0.5rem">
                ...
                <Text>info@bringimagetolife.com</Text>
              </Stack>
            </Stack>
          </Stack>
          {/* Email form */}
      ...
      <Container maxW="container.xl" py="1.25rem" textAlign="center">
        ©2022 AI Anotate Ltd, All rights reserved
      </Container>
    </Box>
  );
}
